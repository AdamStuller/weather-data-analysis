...
# denisty plot - porovnanie priebehu hustoty pravdepodobnosti normálneho rozdelenia (zelená čiara)a odhadu hustoty vypočítaného z namernaých hodnôt teploty (červená čiara)
# Čiary nie sú rovnaké, vrch rozdelenia je mierne zvlenný oproti normálnemu rozdeleniu. Krivka teploty je viac plochá ako krivka normálneho rozdelenia, o čom svedčí aj hodnota špicatosti, ktorá je o niečo nižšia ako hodnota špicatosti normálneho rozdelenia.
...
# diagram rozptylenia
stripchart(TMP~month,
  data = mandatory_date_split,
