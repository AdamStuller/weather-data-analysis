...
V grafov je priemerná denná teplota rozdelená do 6 skupín nasledovne:
...
Pre každú skupinu a každý rok sú spočítané počety dní kedy bola teplota v danom intervale.
